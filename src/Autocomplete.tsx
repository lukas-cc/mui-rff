...
>(
	...
	const restTextFieldPropsInput: Partial<InputBaseProps> | undefined =
			...
			renderInput={(params) => (
				<TextField
					...
					slotProps={{
						input: {
							...params.InputProps,
							...restTextFieldPropsInput,
							...(restTextFieldPropsInput?.startAdornment && {
								startAdornment: (
									<>
										{restTextFieldPropsInput.startAdornment}
							...
							...(restTextFieldPropsInput?.endAdornment && {
								endAdornment: (
									<>
